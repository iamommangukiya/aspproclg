<%@ Page Title="" Language="VB" MasterPageFile="~/pages/MasterPage.master" AutoEventWireup="false" CodeFile="Viewprofile.aspx.vb" Inherits="pages_Default" %>
       ...
       <table class="table" >
         <tr>
            <td class="" align="center" style="width: 100% ; padding-top:50px ; width: 600px">
                <asp:Label ID="lblmsg" runat="server" ForeColor="" Font-Bold="True" Font-Names="Microsoft Sans Serif">*Details of profile which you have been selected</asp:Label>
            </td>
        </tr>
       <tr>
          <td align="center">
