...
<div class ="row  px-5 justify-content-center">
 <h1 class="common_headline  justify-content-center px-5 pt-5 fw-bold  position-absolute"  style="top:80px;font-size:40px ; ">Trusted Matrimony &amp; Matchmaking Service</h1>

  <div class="form-row d-flex  flex-direction-row px-5 serch justify-content-center" style="width: 100%;
    left: 0;
    right: 0;
...
<asp:ListItem>Other</asp:ListItem>
    ...
    <div class="justify-content-center d-flex flex-direction-column" ><img data-testid="live_mobile_img" class="" width="420" height="433" alt="live" src="../images/shaadiLiveImage.png">
    ...
    text-align: center;">Find your Special Someone</h2>
        <div class="row" data-testid="feature_items">
            <div data-testid="sign_up_feature" class="col-sm-4 text-center"><a title="Create your Matrimony Profile"
                    id="sign_up_icon" href="" class=""><span
                        class=""></span></a>
            ...
            <a title="Connect with Matrimony Profiles"
                    id="connect_icon" ><span
                        class=""></span></a>
                <div class=""><a id="connect_link"
                        class="" href="">Connect</a>
            ...
            <div data-testid="interact_feature" class="col-sm-4 text-center"><a
                    ...
                    class=""><span class=""></span></a>
                <div class=""><a id="interact_link"
                        class="" href="">Interact</a>
